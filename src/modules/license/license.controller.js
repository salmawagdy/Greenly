...
import { uploadCloudLicenseFiles } from '../../utilis/multer/cloud.multer.js'
import {Router}from "express"
const router = Router();

router.post('/getByStatus',authentication(),licenseServices.getLicensesByStatus)
router.post('/requestLicense',authentication(),authorization(endpoint.userRequest),uploadCloudLicenseFiles,validation(validators.requestLicenseValidation), licenseServices.requestLicense)
